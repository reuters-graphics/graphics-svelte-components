...
function v(s) {
  ...
  return {
    ...
    l(t) {
      ...
      var p = n(E);
      (g = c(p, P)), p.forEach(u), (x = m(t)), $ && $.l(t), (b = i());
    },
    m(s, t) {
      p(s, r, t),
        f(r, a),
    ...
    p(s, [r]) {
      1 & r && l(a, s[0]),
        2 & r && P !== (P = s[1].message + '') && l(g, P),
        s[1].stack
          ? $
            ? $.p(s, r)
            : (($ = k(s)), $.c(), $.m(b.parentNode, b))
          : $ && ($.d(1), ($ = null));
    },
    i: h,
    o: h,
    d(s) {
      s && u(r), s && u(v), s && u(E), s && u(x), $ && $.d(s), s && u(b);
    },
  };
}
