    ...
    (document.title = n = r[0]),
    {
      ...
      p(I, [d]) {
        d & 32 && e(t, 'lang', I[5]),
          ...
          d & 4 && e(f, 'content', I[2]),
          d & 8 && e(T, 'content', I[3]),
          d & 16 && g !== (g = Y(I[4])) && e(A, 'content', g),
          d & 64 && F !== (F = `https://${I[6]}`) && e(D, 'content', F),
          d & 4 && e(x, 'content', I[2]),
          d & 8 && e(C, 'content', I[3]),
          d & 16 && P !== (P = Y(I[4])) && e(E, 'content', P);
      },
      i: ne,
      o: ne,
      d(I) {
...
function We(r, t, n) {
  ...
  const f = V(z, 'homepage')
    ? W(z.homepage, s.path, { trailingSlash: !0 })
    : V(z, 'reuters.preview')
    ? W(z.reuters.preview, s.path, { trailingSlash: !0 })
    : s.host
    ? W('https://' + s.host, s.path, { trailingSlash: !0 })
    : `https://${y}`;
  ...
  const T = {
    ...
    A = {
      ...
      thumbnailUrl: Y(b),
      image: [
        { '@context': 'http://schema.org', '@type': 'ImageObject', url: Y(b) },
      ],
      ...
      dateCreated: V(z, 'reuters.graphic.published'),
      datePublished: V(z, 'reuters.graphic.published'),
      dateModified: V(z, 'reuters.graphic.updated'),
      author: V(z, 'reuters.graphic.authors', []).map(
...
function Ze(r) {
  ...
  (i = new se({ props: { fw: !0, size: 'md', icon: Se.faCog } })),
    (y = new se({ props: { fw: !0, icon: Le.faHome } })),
...
class at extends ee {
  constructor(t) {
    super();
    te(this, t, et, Ze, re, { components: 0 });
  }
}
var it = [
  {
...
export { at as M, st as N, nt as S, it as c, Y as g };
