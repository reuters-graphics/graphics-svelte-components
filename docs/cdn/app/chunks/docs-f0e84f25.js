...
import { g as J } from './@component-docs_components-de85c4de.js';
  ...
  return (
    (c.$$set = (a) => {
      'src' in a && e(0, (n = a.src)),
        ...
        'top' in a && e(12, (k = a.top)),
        'bottom' in a && e(13, (i = a.bottom)),
        'left' in a && e(14, (u = a.left)),
        'right' in a && e(15, (d = a.right));
    }),
    [n, l, m, r, o, s, p, I, g, E, _, O, k, i, u, d, X]
  );
}
class lt extends P {
  constructor(t) {
