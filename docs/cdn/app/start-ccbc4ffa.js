...
const Lt = {},
  Ee = [
    ...
    () =>
      fe(
        () => import('./pages/index.svelte-feceaf2d.js'),
        [
          'pages/index.svelte-feceaf2d.js',
          'assets/pages/index.svelte-2297a631.css',
          'chunks/vendor-f398e5e0.js',
          'assets/vendor-c9bf64b2.css',
          'chunks/@component-docs_components-2a0c7bac.js',
    ...
    () =>
      fe(
        () => import('./pages/components/_slug_.svelte-7225fd4e.js'),
        [
          'pages/components/_slug_.svelte-7225fd4e.js',
