...
<nav class:open>
  <div class="nav-container">
    ...
    <ul>
      <li class="stationary">
        <a href="{`${base}/`}" rel="external"><Fa fw icon="{faHome}" /> Home</a>
      </li>
      <li class="stationary">
        <a
          href="https://github.com/reuters-graphics/graphics-svelte-components"
          rel="external"><Fa fw icon="{faGithubAlt}" /> Repo</a
        >
      </li>
      <hr />
